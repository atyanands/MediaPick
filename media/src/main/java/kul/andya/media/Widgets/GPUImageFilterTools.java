...
package kul.andya.media.Widgets;
...
import kul.andya.media.GPUImage.*;
import kul.andya.media.R;

public class GPUImageFilterTools {
   public final static FilterList filters = new FilterList();
    ...
    public static void load_filters(){
    ...
    public static GPUImageFilter createBlendFilter(Context context, Class<? extends GPUImageTwoInputFilter> filterClass) {
        try {
            ...
            filter.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.ee));
            return filter;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public static class FilterList {
        ...
        public static List<FilterType> filters = new LinkedList<FilterType>();
